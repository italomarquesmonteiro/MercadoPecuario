...
boi_rs <- readr::read_csv(
    "c:/Users/italo/Desktop/GitHub/NESPro/.vscode/Dataset/GadoGordo.csv" # nolint
  ) |>
...
bezerro_rs <- readr::read_csv(
  "c:/Users/italo/Desktop/GitHub/NESPro/.vscode/Dataset/GadoReposição.csv" # nolint
  ) |>
...
agio <- agio_do_bezerro_rs |>
  ggplot(aes(x = data, y = agio)) +
    ...
    geom_hline(yintercept = 15, lty = 3, color = "grey20") +
