...
```{r Datasets}
bezerro <- readr::read_csv("c:/Users/italo/OneDrive/Área de Trabalho/GitHub/cepea-esalq/Dataset cepea/CalfPrice.csv") |> # nolint
  dplyr::select(data, preco_bezerro = a_vista_r)

boi <- readr::read_csv("C:/Users/italo/OneDrive/Área de Trabalho/GitHub/cepea-esalq/Dataset cepea/CepeaBoiGordo.csv" ) |> # nolint 
...
```{r}
ggsave("Graph index/RelaçãoTroca.png", plot = plot_relacao_troca, dpi = 300)
```